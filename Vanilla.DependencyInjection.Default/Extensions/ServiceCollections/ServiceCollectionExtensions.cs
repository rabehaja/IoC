...
namespace Vanilla.DependencyInjection.Default.Extensions.ServiceCollections
{
    /// <summary>
    /// ServiceCollectionExtension taken from @kamsar. Url:https://gist.github.com/kamsar/460528edc3043b16bdccfdbd0ea0c552.
    /// Used here as a reference and part of the default implementation of Sitecore's default dependency injection.
    /// </summary>
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddMvcControllers(this IServiceCollection serviceCollection, params Assembly[] assemblies)
        {
            ...
            var apiControllers = GetTypesImplementing<IHttpController>(assemblies)
                .Where(controller => controller.Name.EndsWith("Controller", StringComparison.Ordinal));
